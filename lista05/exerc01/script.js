...
//Iniciando o jogo
resultado.innerHTML = "Escolha um número inteiro qualquer";
indicador.innerHTML = "";
input.value = "";
...
jogar.addEventListener("mouseover", () => {
	if (input.value === "") {
		alert ('O campo de entrada está vazio! Digite um número para jogar!')
	}
});
...
jogar.addEventListener("click", () =>{
	fetch('/jogar', {
		...
		body: JSON.stringify({ escolha: escolha.value, numero: parseInt(input.value) })
